...
saved_output_filename = "output/internal_tide_0.5days-theta=0.0022Drealtopo_coarse_TF_horizontal_average.jld2"
...
pe_avg = FieldTimeSeries(saved_output_filename, "pe_avg")


εg = zeros(size(ug,1),size(ug,2),10)
for i in 3:2:21
εg[:,:,i]=file[string("timeseries/ε","/$i")][5:end-4,5,1]
end

# Define a function to calculate horizontal average
